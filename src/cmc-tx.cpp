...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CMC Core cmc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cmc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cmc transaction") + "\n" +
              "  cmc-tx [options] -create [commands]   " + _("Create hex-encoded cmc transaction") + "\n" +
              "\n";
